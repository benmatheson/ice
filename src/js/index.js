...
<option value='ALABAMA'> Alabama ⬍  </option> <option value='ALASKA'> Alaska </option> <option value='ARIZONA'> Arizona </option>  <option value='CALIFORNIA'> California </option> <option value='COLORADO'> Colorado </option> <option value='CONNECTICUT'> Connecticut </option> <option value='DELAWARE'> Delaware </option> <option value='FLORIDA'> Florida </option> <option value='GEORGIA'> Georgia </option> <option value='IDAHO'> Idaho </option> <option value='ILLINOIS'> Illinois </option> <option value='INDIANA'> Indiana </option> <option value='IOWA'> Iowa </option> <option value='KANSAS'> Kansas </option> <option value='KENTUCKY'> Kentucky </option> <option value='LOUISIANA'> Louisiana </option> <option value='MAINE'> Maine </option> <option value='MARYLAND'> Maryland </option> <option value='MASSACHUSETTS'> Massachusetts </option> <option value='MICHIGAN'> Michigan </option> <option value='MINNESOTA'> Minnesota </option> <option value='MISSISSIPPI'> Mississippi </option> <option value='MISSOURI'> Missouri </option> <option value='MONTANA'> Montana </option> <option value='NEBRASKA'> Nebraska </option> <option value='NEVADA'> Nevada </option> <option value='NEW HAMPSHIRE'> New Hampshire </option> <option value='NEW JERSEY'> New Jersey </option> <option value='NEW MEXICO'> New Mexico </option> <option value='NEW YORK'> New York </option> <option value='NORTH CAROLINA'> North Carolina </option> <option value='NORTH DAKOTA'> North Dakota </option> <option value='OHIO'> Ohio </option> <option value='OKLAHOMA'> Oklahoma </option> <option value='OREGON'> Oregon </option> <option value='PENNSYLVANIA'> Pennsylvania </option> <option value='RHODEISLAND'> RhodeIsland </option> <option value='SOUTH CAROLINA'> South Carolina </option> <option value='SOUTH DAKOTA'> South Dakota </option> <option value='TENNESSEE'> Tennessee </option> <option value='TEXAS'> Texas </option> <option value='UTAH'> Utah </option> <option value='VERMONT'> Vermont </option> <option value='VIRGINIA'> Virginia </option> <option value='WASHINGTON'> Washington </option> <option value='WEST VIRGINIA'> West Virginia </option> <option value='WISCONSIN'> Wisconsin </option>
